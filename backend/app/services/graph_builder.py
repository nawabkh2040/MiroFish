...
class GraphBuilderService:
    ...
    Responsible for building a knowledge graph using the Zep API.
    """
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required by the Zep SDK; the warning comes from dynamic class creation and is safe to ignore.
        warnings.filterwarnings('ignore', category=UserWarning, module='pydantic')
        
        # Names reserved by Zep cannot be used as attribute names.
        RESERVED_NAMES = {'uuid', 'name', 'group_id', 'name_embedding', 'summary', 'created_at'}
        
        def safe_attr_name(attr_name: str) -> str:
            """Convert reserved names into safe attribute names."""
        ...
        for entity_def in ontology.get("entity_types", []):
            ...
            for attr_def in entity_def.get("attributes", []):
                attr_name = safe_attr_name(attr_def["name"])  # Use a safe name
                attr_desc = attr_def.get("description", attr_name)
                # Zep API requires Field descriptions.
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            A dict containing nodes and edges, including time information, attributes, and other details.
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
