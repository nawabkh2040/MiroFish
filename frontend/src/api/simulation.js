...
/**
 * Retrieve Agent Profiles currently being generated in real time
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Retrieve simulation configuration in real time whilst it is being generated
 * @param {string} simulationId
 * @returns {Promise} Returns configuration information including metadata and config content
 */
