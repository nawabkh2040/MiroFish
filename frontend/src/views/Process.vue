<template>
  <div class="process-page">
    ...
    <div class="main-content">
      <!-- Left panel: real-time graph view -->
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyses the content and automatically generates an ontology structure suitable for opinion simulation (entity types + relation types)
                </div>
              </div>
...
// Initialise - handle new project or load existing one
...
const handleNewProject = async () => {
  ...
  try {
    ...
    ontologyProgress.value = { message: 'Uploading files and analysing documents...' }
